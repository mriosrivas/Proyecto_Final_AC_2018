...
HD_PWD='/home/manuel/Desktop/Display/Display.runs/microblaze_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_axi_gpio_1_1.tcl
