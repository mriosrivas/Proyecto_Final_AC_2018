...
HD_PWD='/home/manuel/Desktop/LED_Switch/LED_Switch.runs/microblaze_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_axi_gpio_0_1.tcl
